...
function menu() {
  let menu = document.querySelector(".mobileNav i")
  // console.log(menu)
  menu.addEventListener("click", function () {
    ...
    centerNav.style.width= '100%'
    centerNav.style.alignItems = 'center'
    centerNav.style.justifyContent= 'center'
    centerNav.style.flexDirection= 'column'


    let mobImg = document.querySelector('.mobileNav>img')
    // console.log(mobImg)
    // mobImg.style.width= '8vw'


    const centerNavlinks = document.querySelectorAll('.navLink') 
    centerNavlinks.forEach(function(anchor) {
      console.log(anchor)
